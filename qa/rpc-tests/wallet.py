...
#   c) node1 mines 32 blocks, so now node 0 has 60001dwe, node 1 has 4250dwe, node2 has none.
#   d) node0 sends 601 dwe to node2, in two transactions (301 dwe, then 300 dwe).
