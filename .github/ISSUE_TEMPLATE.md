...
This issue tracker is only for technical issues related to DWE Core.
General DWE questions and/or support requests and are best directed to the [DWE Slack](http://dwe.slack.com).
...
### What version of DWE Core are you using?
