...
In order to support loading of multiple wallets in dwe-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dwe.cpp.
...
Changes to dwe.cpp
----------------------
dwe.cpp is the entry point into dwe-qt, and as such, will require some minor modifications to provide hooks for
