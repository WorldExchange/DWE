...
*Setup instructions for a gitian build of DWE using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the DWE
...
To build DWE (for Linux, OSX and Windows) just follow the steps under 'perform
