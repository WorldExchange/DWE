...
This mechanism has been integrated into Bitcore-Node-DWE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DWE-Project/insight-api-dwe#web-socket-api](https://github.com/DWE-Project/insight-api-dwe#web-socket-api) 
* API: [https://github.com/DWE-Project/insight-api-dwe#swifttx-transactions](https://github.com/DWE-Project/insight-api-dwe#swifttx-transactions) 
...
By default, the DWE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DWE Core daemon:
