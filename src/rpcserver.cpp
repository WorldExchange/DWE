...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dwe features */
        {"dwe", "masternode", &masternode, true, true, false},
        {"dwe", "listmasternodes", &listmasternodes, true, true, false},
        {"dwe", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dwe", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dwe", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dwe", "masternodedebug", &masternodedebug, true, true, false},
        {"dwe", "startmasternode", &startmasternode, true, true, false},
        {"dwe", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dwe", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dwe", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dwe", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dwe", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dwe", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dwe", "mnbudget", &mnbudget, true, true, false},
        {"dwe", "preparebudget", &preparebudget, true, true, false},
        {"dwe", "submitbudget", &submitbudget, true, true, false},
        {"dwe", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dwe", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dwe", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dwe", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dwe", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dwe", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dwe", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dwe", "checkbudgets", &checkbudgets, true, true, false},
        {"dwe", "mnsync", &mnsync, true, true, false},
        {"dwe", "spork", &spork, true, true, false},
        {"dwe", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dwe", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dwed, or the -server option to dwe-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dwe-cli " + methodname + " " + args + "\n";
}
