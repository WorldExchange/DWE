...
Setup
---------
Configuring the github-merge tool for the DWE repository is done in the following way:

    git config githubmerge.repository DWE-Project/DWE
...
A script to optimize png files in the DWE
