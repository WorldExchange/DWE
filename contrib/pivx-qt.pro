...
RESOURCES += src/qt/dwe.qrc src/qt/dwe_locale.qrc

TRANSLATIONS += src/qt/locale/dwe_bg.ts \
                src/qt/locale/dwe_de.ts \
                src/qt/locale/dwe_en.ts \
                src/qt/locale/dwe_es.ts \
                src/qt/locale/dwe_fi.ts \
                src/qt/locale/dwe_fr.ts \
                src/qt/locale/dwe_it.ts \
                src/qt/locale/dwe_ja.ts \
                src/qt/locale/dwe_pl.ts \
                src/qt/locale/dwe_pt.ts \
                src/qt/locale/dwe_ru.ts \
                src/qt/locale/dwe_sk.ts \
                src/qt/locale/dwe_sv.ts \
                src/qt/locale/dwe_vi.ts \
                src/qt/locale/dwe_zh_CN.ts \
                src/qt/locale/dwe_zh_TW.ts
